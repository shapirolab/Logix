/*
Precompiler for Stochastic Pi Calculus procedures - transform optimizer

Bill Silverman, December 1999.

Last update by          $Author: bill $
                        $Date: 2005/07/19 14:47:24 $
Currently locked by     $Locker:  $
                        $Revision: 1.3 $
                        $Source: /home/qiana/Repository/Aspic/spifcp/optimize.cp,v $
...
remove_unused(LHS, Uses, NewLHS) + (Index = 2, Outdex = 1) :-
    ...
    arg(1, LHS, Functor) :
      ...
      NewLHS = OutLHS,
      Name = Functor |
	check_included_variable(NewLHS, Uses, `"Scheduler.", Outdex, Outdex'),
