...
Last update by          $Author: bill $
			$Date: 2000/07/09 06:33:35 $
Currently locked by     $Locker:  $
			$Revision: 1.1 $
			$Source: /home/qiana/Repository/PsiFcp/psidbg/user.cp,v $
...
ask(Signals, Answer, Location, Goal, Debug_Info, NewDebug_Info,
	...
	Channels   = {IO,_User,Psi} :
	    Signals = _, Execute_Info = _,
	    NewDebug_Info = Debug_Info |
		write(" goal "(Goal, Goal'), Psi),
